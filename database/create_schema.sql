...
CREATE TABLE ytkp.video (
    ...
    video_avail VARCHAR(255) NOT NULL,
    video_lang VARCHAR(255) NOT NULL,
...
COMMENT ON COLUMN ytkp.video.video_avail IS 'Availability status of the video - it might be used to download videos that aren\'t public no more';
